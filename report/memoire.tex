...
\newcommand{\FTitre}{FACULTÉ DES SCIENCES}
...
\includegraphics[width=0.2\textwidth]{FS} \hspace{0.6\textwidth} \includegraphics[width=0.2\textwidth]{logo_UMONS} \hspace{0.2\textwidth} 
...
\include{chapters/3-pipeline_architecture}
\include{chapters/4-dataset_and_fine-tuning}
\include{chapters/5-experiments_and_results}
