...
if __name__ == "__main__":
    ...
    MASKS_PARENT_FOLDER_PATH = os.path.join(ROOT_DIR, "data", "outputs", VIDEO_NAME, "sam3_filtered")
    OUTPUT_PATH = os.path.join(ROOT_DIR, "data", "outputs", VIDEO_NAME, "frames_without_background")
