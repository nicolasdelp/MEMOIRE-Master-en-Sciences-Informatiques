...
import numpy as np
import models.sam3.model.sam3_multiplex_base
import models.sam3.model.sam3_video_base
import torch
import torch.distributed as dist
import torch.nn.functional as F
from models.sam3 import perflib
from models.sam3.logger import get_logger
from models.sam3.model.box_ops import box_xywh_to_cxcywh, box_xyxy_to_xywh
from models.sam3.model.data_misc import BatchedDatapoint
from models.sam3.model.sam3_multiplex_base import MaskletConfirmationStatus, Sam3MultiplexBase
from models.sam3.model.sam3_tracker_utils import fill_holes_in_mask_scores
from models.sam3.model.sam3_video_inference import is_image_type
from models.sam3.perflib.compile import (
    clone_output_wrapper,
    compile_wrapper,
    shape_logging_wrapper,
)
from models.sam3.perflib.masks_ops import mask_iou, masks_to_boxes as perf_masks_to_boxes
...
from models.sam3.model.data_misc import (
    BatchedPointer,
    convert_my_tensors,
    FindStage,
    NestedTensor,
)
from models.sam3.model.geometry_encoders import Prompt
from models.sam3.model.io_utils import load_resource_as_video_frames
...
class Sam3MultiplexTracking(Sam3MultiplexBase):
    ...
    def _compile_model(self):
        ...
        models.sam3.model.sam3_video_base._associate_det_trk_compilable = compile_wrapper(
            models.sam3.model.sam3_video_base._associate_det_trk_compilable,
            mode="max-autotune-no-cudagraphs",
            fullgraph=True,
            dynamic=False,
        )
