...
from models.sam3.model.decoder import (
...
from models.sam3.model.encoder import TransformerEncoderFusion, TransformerEncoderLayer
from models.sam3.model.geometry_encoders import SequenceGeometryEncoder
from models.sam3.model.maskformer_segmentation import PixelDecoder, UniversalSegmentationHead
from models.sam3.model.memory import (
    CXBlock,
    SimpleFuser,
    SimpleMaskDownSampler,
    SimpleMaskEncoder,
)
from models.sam3.model.model_misc import (
    DotProductScoring,
    MLP,
    MultiheadAttentionWrapper as MultiheadAttention,
    TransformerWrapper,
)
from models.sam3.model.multiplex_utils import MultiplexController
from models.sam3.model.necks import Sam3DualViTDetNeck, Sam3TriViTDetNeck
from models.sam3.model.position_encoding import PositionEmbeddingSine
from models.sam3.model.sam1_task_predictor import SAM3InteractiveImagePredictor
from models.sam3.model.sam3_image import Sam3Image, Sam3ImageOnVideoMultiGPU
from models.sam3.model.sam3_tracking_predictor import Sam3TrackerPredictor
from models.sam3.model.sam3_video_inference import Sam3VideoInferenceWithInstanceInteractivity
from models.sam3.model.sam3_video_predictor import Sam3VideoPredictorMultiGPU
from models.sam3.model.text_encoder_ve import VETextEncoder
from models.sam3.model.tokenizer_ve import SimpleTokenizer
from models.sam3.model.video_tracking_multiplex import VideoTrackingDynamicMultiplex
from models.sam3.model.vitdet import ViT
from models.sam3.model.vl_combiner import SAM3VLBackbone, SAM3VLBackboneTri, TriHeadVisionOnly
from models.sam3.sam.transformer import RoPEAttention
...
def _create_sam3_model(
    ...
    matcher = None
    if not eval_mode:
        from models.sam3.train.matcher import BinaryHungarianMatcherV2
...
def build_sam3_multiplex_video_model(
    ...
    from models.sam3.model.video_tracking_multiplex_demo import Sam3VideoTrackingMultiplexDemo
...
def build_sam3_multiplex_video_predictor(
    ...
    from models.sam3.model.sam3_multiplex_base import Sam3MultiplexPredictorWrapper
    from models.sam3.model.sam3_multiplex_detector import Sam3MultiplexDetector
    from models.sam3.model.sam3_multiplex_tracking import (
        Sam3MultiplexTrackingWithInteractivity,
    )
    from models.sam3.model.sam3_multiplex_video_predictor import Sam3MultiplexVideoPredictor
