...
def main(image_folder_path, output_path, visualisation=False, visualisation_output_path=None):
...
if __name__ == "__main__":
    ...
    OUTPUT_PATH = os.path.join(ROOT_DIR, "data", "outputs", VIDEO_NAME, "moge")
    VISUALISATION_OUTPUT_PATH = os.path.join(ROOT_DIR, "data", "outputs", VIDEO_NAME, "moge_visualisation")
