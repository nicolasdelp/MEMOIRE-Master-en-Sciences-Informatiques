...
if __name__ == "__main__":
    ...
    FRAME_FOLDER_PATH = f"/media/pc/hdd2/data-students/nicolasdelplanque/TrackMyLift-AI/data/outputs/{VIDEO_NAME}/original/occluded_frames_without_background/"
    OUTPUT_FOLDER_PATH = f"/media/pc/hdd2/data-students/nicolasdelplanque/TrackMyLift-AI/data/outputs/{VIDEO_NAME}/original/sam3dbody/occulted/"
